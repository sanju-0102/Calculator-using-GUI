#==================================================================================#
#   Aim : Create a Scientific Calculator in Python using Graphical User Interface  #
#                                                                                  #
...
#=======================================================================#
    ...
    def deg(self):
        self.result = False
        self.current = math.deg(float(txtDisplay.get()))
        self.display(self.current)
...
btnexpml = Button(calc,text='expm1', width=6, height=2, font=('arial',20,'bold'),bd=4,bg="powder blue",
